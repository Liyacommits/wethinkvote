...
import { ArrowLeft, Blocks, Loader2, Plus, Trash2 } from "lucide-react"
    ...
    <div className="container py-12">
      <div className="flex flex-col max-w-4xl mx-auto">
        <div className="w-full mb-8">
          ...
          <p className="text-muted-foreground">Manage voting categories and positions for wethinkvote elections</p>
        </div>
