...
import { ArrowLeft, BarChart3, Clock, Download, ExternalLink, RefreshCw } from "lucide-react"
    ...
    <div className="container py-12">
      <div className="flex flex-col items-center max-w-4xl mx-auto">
        <div className="w-full mb-8">
          ...
          <p className="text-muted-foreground">Live results for the Presidential Election 2025</p>
        </div>
        ...
        <Card className="w-full">
          ...
          <CardContent>
            ...
            <div className="mt-8 pt-4 border-t">
              <div className="flex justify-between items-center">
                <p className="text-sm text-muted-foreground">Results are verified on the Sepolia testnet</p>
                <Link
