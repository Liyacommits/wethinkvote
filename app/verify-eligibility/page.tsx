...
import { ArrowLeft, Blocks, CheckCircle2, Loader2, ShieldAlert } from "lucide-react"
    ...
    <div className="container flex items-center justify-center min-h-screen py-12">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Verify your eligibility to vote in wethinkvote elections</CardDescription>
        </CardHeader>
        <CardContent>
          {verified ? (
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              ...
              {error && (
              <div className="bg-destructive/10 border border-destructive/40 text-destructive px-4 py-3 rounded-lg flex items-start gap-2">
