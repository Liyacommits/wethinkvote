          ...
          <CardContent>
            <div className="flex flex-col items-center justify-center py-6 text-center">
              ...
              <p className="text-muted-foreground mt-2 mb-6">
                Your vote has been recorded on the Sepolia testnet and cannot be changed.
              </p>
              <Link href="/results">
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <div className="flex flex-col items-center justify-center py-6 text-center">
              ...
              <h3 className="text-xl font-bold">Thank You For Voting!</h3>
              <p className="text-muted-foreground mt-2 mb-6">
                Your vote has been securely recorded on the Sepolia testnet. The transaction hash has been sent to your
      ...
      <div className="flex flex-col items-center max-w-4xl mx-auto">
        <div className="w-full mb-8">
          ...
          <p className="text-muted-foreground">
            Select your preferred candidate in the Presidential Election 2025
          </p>
        </div>
        ...
        <Alert className="mb-6">
          ...
          <AlertDescription>
            Your vote will be recorded on the Sepolia testnet and cannot be changed once submitted. Make sure to review
        ...
        <Card className="w-full">
          <CardHeader>
            <CardTitle>wethinkvote Election 2025</CardTitle>
